...
<body>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center"> <!-- Centers the row in the container -->
            <div class="col-lg-10 border border-dark" id="content-container">
                <p class="empty-text">Create a post</p>
            </div>

            <div class="col-lg-2 border border-dark"> <!-- Adjusted column size to better center -->
            <label class="form-label">Add Content</label>
                ...
                <form method="POST" action="submit-form.php">
                    ...
                    <div class="d-flex flex-column mt-3">
                        <button type="submit" class="btn btn-primary mb-2" onclick="validateForm()">Post</button>
                        <button type="button" class="btn btn-secondary mb-2" onclick="window.location.href='../pages/index.php'">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        // Continue with form submission if the title is filled out
